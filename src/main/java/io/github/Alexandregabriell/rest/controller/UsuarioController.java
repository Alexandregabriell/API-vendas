...
import io.github.Alexandregabriell.rest.dto.CredenciaisDTO;
import io.github.Alexandregabriell.rest.dto.TokenDTO;
...
public class UsuarioController {
    ...
    public TokenDTO autenticar(@RequestBody CredenciaisDTO credenciais){
        try {
            ...
            UserDetails usuarioAutenticado = usuarioService.autententicar(usuario);
